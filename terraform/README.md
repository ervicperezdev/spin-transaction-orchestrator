...
- This foundation does not create DNS, ACM/WAF, secret values, observability, the Secrets Store CSI driver/provider add-on, EKS OIDC provider bootstrap, EKS access entries/RBAC, or a production CI apply path. Those remain account-owned integration steps.
